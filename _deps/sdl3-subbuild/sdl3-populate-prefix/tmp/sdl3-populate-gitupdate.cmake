...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "release-3.2.16"
  WORKING_DIRECTORY "/home/mrdeun/Workspace/CHIP8/_deps/sdl3-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/mrdeun/Workspace/CHIP8/_deps/sdl3-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/mrdeun/Workspace/CHIP8/_deps/sdl3-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
